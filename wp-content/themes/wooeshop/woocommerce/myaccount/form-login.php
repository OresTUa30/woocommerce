...
<div class="container">
	...
	<div class="u-columns col2-set row text-center justify-content-center mb-5" id="customer_login">

		<div class="u-column1 col-md-6 col-12">

			<h2 class="section-title"><span><?php esc_html_e('Login', 'woocommerce'); ?></span></h2>
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
					<label class = "form-label" for="password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span class="required  form-label">*</span></label>
				...
				<div class="form-row">
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme form-label my-2">
						<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e('Remember me', 'woocommerce'); ?></span>
					</label>
					<?php wp_nonce_field('woocommerce-login', 'woocommerce-login-nonce'); ?>
					<button type="submit" class="m-auto d-block btn btn-warning w-100 woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
				</div>
		...
		<div class="u-column2 col-md-6 col-12">

			<h2 class="section-title"><span><?php esc_html_e('Register', 'woocommerce'); ?></h2>
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
				...
				<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
					<label class = "form-label" for="reg_email"><?php esc_html_e('Email address', 'woocommerce'); ?>&nbsp;<span class="required form-label">*</span></label>
				...
				<?php if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
					...
					<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label class = "form-label" for="reg_password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span class="required form-label">*</span></label>
